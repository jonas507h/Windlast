    ...
    *,
    ...
    if methode is RechenmethodeAbheben.STANDARD:
        ...
        for winkel, richtung in generiere_windrichtungen(anzahl=anzahl_windrichtungen, protokoll=protokoll, breadcrumb=base_bc):
            ...
            for element, lastfaelle_elem in kraefte_nach_element.items():
                ...
                protokolliere_ergebnis(
                    ...
                    wert=N_down_b,
                    label="math.abhebe_normalkraft_down_element.label",
                ...
                protokolliere_ergebnis(
                    ...
                    wert=N_up_b,
                    label="math.abhebe_normalkraft_up_element.label",
            ...
            protokolliere_ergebnis(
                ...
                label="math.abhebe_normalkraft_down_richtung.label",
            ...
            protokolliere_ergebnis(
                ...
                label="math.abhebe_normalkraft_up_richtung.label",
            ...
            protokolliere_ergebnis(
                ...
                label="math.abhebe_sicherheit_richtung.label",
            ...
            protokolliere_ergebnis(
                ...
                label="math.abhebe_ballast_richtung.label",
                formelzeichen="math.abhebe_ballast_richtung.symbol",
                wert=ballastkraft,
                einheit="N",
        ...
        protokolliere_ergebnis(
            ...
            label="math.abhebe_sicherheit.label",
        ...
        protokolliere_ergebnis(
            ...
            breadcrumb=base_bc,
            name="ballast_abhebe",
            label="math.abhebe_ballast.label",
            formelzeichen="math.abhebe_ballast.symbol",
            wert=ballast_kg,
            einheit="kg",
