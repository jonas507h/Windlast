    ...
    *,
    ...
    if methode is RechenmethodeGleiten.MIN_REIBWERT:
        ...
        for winkel, richtung in generiere_windrichtungen(anzahl=anzahl_windrichtungen, protokoll=protokoll, breadcrumb=base_bc):
            ...
            for element, lastfaelle_elem in kraefte_nach_element.items():
                ...
                protokolliere_ergebnis(
                    ...
                    wert=H_vec,
                    label="math.gleit_horizontalkraft_element.label",
                ...
                protokolliere_ergebnis(
                    ...
                    wert=N_down,
                    label="math.gleit_normalkraft_down_element.label",
                ...
                protokolliere_ergebnis(
                    ...
                    name="normalkraft_up",
                    wert=N_up,
                    label="math.gleit_normalkraft_up_element.label",
            ...
            protokolliere_ergebnis(
                ...
                label="math.gleit_horizontalkraft_richtung.label",
            ...
            protokolliere_ergebnis(
                ...
                label="math.gleit_normalkraft_down_richtung.label",
            ...
            protokolliere_ergebnis(
                ...
                label="math.gleit_normalkraft_up_richtung.label",
            ...
            protokolliere_ergebnis(
                ...
                label="math.gleit_normalkraft_effektiv_richtung.label",
            ...
            protokolliere_ergebnis(
                ...
                name="reibkraft",
                wert=reibkraft,
                label="math.gleit_reibkraft_richtung.label",
            ...
            protokolliere_ergebnis(
                ...
                wert=ballastkraft,
                label="math.gleit_ballast_richtung.label",
        ...
        protokolliere_ergebnis(
            ...
            name="ballast_gleit",
            wert=ballast_kg,
            label="math.gleit_ballast.label",
